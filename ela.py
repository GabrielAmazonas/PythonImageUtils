...
filename = 'carteira-de-identidade.jpg'
resaved = 'carteira-de-identidade' + '.resaved.jpg'
ela = 'carteira-de-identidade' + '.ela.png'
...
print("Maximum difference was max_diff: ", max_diff)
ela_im.save(ela)
ela_im.show()